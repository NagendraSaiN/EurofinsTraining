...
namespace WebApplication1
{
    public class DbConnection
    {
        ...
        public DataTable ExecuteQry(string sqlquery)
        {
            SqlConnection sqlConnection = new SqlConnection("Data Source = LAPTOP-9EHAL4D8; Initial Catalog =Example; Integrated Security = True");
        ...
        public string InsertCustomer(int C_ID,string C_name,string C_city,string C_grade,int Salesman_ID)
        {
            string insertQuery = "insert into Customer values(" + C_ID + ",'" + C_name + "','" + C_city + "','" + C_grade + "'," + Salesman_ID + ")";
        ...
        {
            string getcustomerbyID = "select * from Customer where customer_ID=" + C_id + "";
            DataTable dt = ExecuteQry(getcustomerbyID);
            return dt;
        }
